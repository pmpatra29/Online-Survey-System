...
public class MainPage {
	...
	public void mainPageView(int id) throws SQLException {
		...
		quesView.setBounds(50, 340, 1500, 50);
		...
		viewNext.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				h++;
                                ...
                                try {
                                    totalQuestions = manage.getMaxQuestionNumber(cd);
                                } catch (SQLException e1) {
                                    e1.printStackTrace();
                                }
                                if(h >= totalQuestions){
                                    viewNext.setEnabled(false);
                                    JOptionPane.showMessageDialog(frame, "No more questions to view.", "Information", JOptionPane.INFORMATION_MESSAGE);
                                    return; 
                                }
